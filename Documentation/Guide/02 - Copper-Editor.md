...
![image caption](Media/02/Copper-Editor.png)
...
![image caption](Media/02/Viewport.png)
...
![image caption](Media/02/GizmoControls.png)
...
### Scene Hierarchy
On the left side of the viewport, you should see the Scene Hierarchy.

![image caption](Media/02/SceneHierarchy.png)
...
![image caption](Media/02/SceneHierarchy2.png)
...
![image caption](Media/02/Properties.png)

At the very top you can see and edit the entities name, and below you will see all of the components attached to this entity alongside a button to add other components to the selected entity.
...
You can imagine it as wall of canvases. Each canvas is an entity, on it's own, it's blank, empty and worthless, but by adding strokes of paint you can form a complex piece of art. The components are like the different colours of paint, you can take multiple of them to fill up one canvas, and then reuse some colours, add different colours, and fill up a second canvas.
...
There are a handful of other components, and many more soon to come, but [here is a list](https://www.google.com) of some of the most important and commonly used components explained more thoroughly.

#### File Mode
When a file is selected in the File Browser, the Properties panel will change to show the Properties of that file.

![image caption](Media/02/PropertiesFile.png)
...
![image caption](Media/02/NewItem.png)
...
![image caption](Media/02/GamePanel.png)
...
![image caption](Media/02/GamePanel2.png)
