...
namespace Editor {
    ...
    void FileBrowser::Initialize() {
        ...
        directoryIcon.Create(ResourceDirectory() / "assets/Icons/FileBrowser/DirectoryIcon.png", Texture::Format::RGBA);
        fileIcon.Create(ResourceDirectory() / "assets/Icons/FileBrowser/FileIcon.png", Texture::Format::RGBA);

        m_font = GetMainUIContext().LoadFont(ResourceDirectory() / "assets/Fonts/IBMPlexMono-Medium.ttf", 16.0f);
